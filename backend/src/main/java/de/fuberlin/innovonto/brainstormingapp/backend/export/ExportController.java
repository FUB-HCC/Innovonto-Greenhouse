package de.fuberlin.innovonto.brainstormingapp.backend.export;
...
import de.fuberlin.innovonto.brainstormingapp.backend.export.vocabulary.GI2MO;
import de.fuberlin.innovonto.brainstormingapp.backend.export.vocabulary.INOV;
import de.fuberlin.innovonto.brainstormingapp.backend.export.vocabulary.MTURK;
import de.fuberlin.innovonto.brainstormingapp.backend.export.vocabulary.OID;
        ...
        for (IdeationSession currentSession : sessionsForCurrentChallenge) {
            ...
            for (Idea inputIdea : ideas) {
                ...
                if (inputIdea.getState() != null) {
                    outputIdea.addProperty(OID.legacyStatus, inputIdea.getState().name());
                }
